  subroutine olinmin(xparam,step,pvect,nvar,funct1,okf,grad,imode)
!*********************************************************************
!
...
!   9/17 default precision increased
!   1/18 Trace added
!
!**********************************************************************
  use control
...
!
  ...
  fmin = funct1
  step = vt(2)
  call daxpy(nvar,step,pvect,1_i4,xparam,1_i4)
  iflag = 0
  if (imode.eq.1) then
...
120  continue
     call daxpy(nvar,s,pvect,1_i4,xparam,1_i4)
     funold = funct1
     iflag = 0
     if (imode.eq.1) then
       call funct(iflag,nvar,xparam,funct1,grad)
